...
parser.add_argument('--beta', type=float, default=8.32e-6)  #feedback weights, B, learning rate
parser.add_argument('--sigma', type=float, default=0.067)  #node pert standard deviation
